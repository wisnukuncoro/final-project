        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <div class="icon-card mb-30">
              ...
              <div class="content">
                <h6 class="mb-10">Prediksi Harga Terendah</h6>
          ...
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <div class="icon-card mb-30">
              ...
              <div class="content">
                <h6 class="mb-10">Prediksi Harga Tertinggi</h6>
          ...
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <div class="icon-card mb-30">
              ...
              <div class="content">
                <h6 class="mb-10">Prediksi Harga Rata-rata</h6>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="terms d-flex justify-content-center justify-content-md-end">
              <p class="text-sm">
                Generated by LSTM Models with 95% Accuracy
              </p>
            </div>
          </div>
          <!-- end row -->
